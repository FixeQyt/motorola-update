...
public class Layer {
    ...
    public String toString(String str) {
        ...
        sb.append(str).append(getName()).append(SystemUpdateStatusUtils.NEWLINE_SEPERATOR);
        ...
        if (layerModelForId != null) {
            ...
            sb.append(str).append(SystemUpdateStatusUtils.NEWLINE_SEPERATOR);
        }
        if (!getMasks().isEmpty()) {
            sb.append(str).append("\tMasks: ").append(getMasks().size()).append(SystemUpdateStatusUtils.NEWLINE_SEPERATOR);
        }
        ...
        if (!this.shapes.isEmpty()) {
            ...
            for (ContentModel contentModel : this.shapes) {
                sb.append(str).append("\t\t").append(contentModel).append(SystemUpdateStatusUtils.NEWLINE_SEPERATOR);
            }
        }
        return sb.toString();
    }
