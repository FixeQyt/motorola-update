...
public class StateUrlConstructor {
    public static String constructUrl(UrlRequest urlRequest) {
        if (!TextUtils.isEmpty(urlRequest.getTestUrl()) && BuildPropertyUtils.isDogfoodDevice()) {
            CDSLogger.v(CDSLogger.TAG, "State Request test url is " + urlRequest.getTestUrl());
        ...
        sb.append("/t/");
        sb.append(urlRequest.getTrackingId());
        sb.append("/s/");
        sb.append(urlRequest.getState());
        sb.append("/ctx/");
        sb.append(urlRequest.getContext());
        sb.append("/key/");
        sb.append(Uri.encode(urlRequest.getContextKey()));
        CDSLogger.v(CDSLogger.TAG, "State Request getUrl(): url is " + sb.toString());
        return sb.toString();
    }
}
