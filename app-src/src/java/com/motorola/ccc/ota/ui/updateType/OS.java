...
public class OS implements UpdateType.UpdateTypeInterface {
    ...
    public int getStatusBarColor() {
        return R.color.os_status_bar;
    }

    @Override // com.motorola.ccc.ota.ui.updateType.UpdateType.UpdateTypeInterface
    public int getSystemUpdateAvailablePendingNotificationText() {
        return R.string.system_update_pending_notification_os_text;
    }

    @Override // com.motorola.ccc.ota.ui.updateType.UpdateType.UpdateTypeInterface
    public int getToolbarColor() {
        return R.color.os_toolbar_bar;
    }
    ...
    public String getSystemUpdateAvailableNotificationText() {
        return this.mContext.getResources().getString(R.string.system_update_notification_os_text);
    }
    ...
    public String getPDLNotificationTitle() {
        ...
        return string == null ? this.mContext.getResources().getString(R.string.system_update) : this.mContext.getResources().getString(R.string.system_pdl_notification_os_title, MetaDataBuilder.from(string).getTargetOSVersion());
    }
